                    ...
                    <div className="sm:hidden border-t border-gray-100 dark:border-gray-800 bg-white/95 dark:bg-gray-900/95 backdrop-blur-lg px-4 pt-3 pb-5 space-y-3 animate-fade-in shadow-xl">
                        ...
                        <div className="space-y-1">
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-between p-3 rounded-xl text-xs font-bold text-emerald-700 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-950/40 transition-all cursor-pointer"
                            >

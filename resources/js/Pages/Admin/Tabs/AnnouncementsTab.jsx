                            ...
                            >
                                ...
                                <div className="pt-3 border-t border-slate-200/60 dark:border-gray-700/80 flex items-center justify-between text-[11px] text-gray-400">
                                    ...
                                    <button
                                        ...
                                        className="inline-flex items-center gap-1 text-xs font-bold text-red-500 hover:text-red-700 dark:hover:text-red-400 transition-colors disabled:opacity-50"
                                    >
